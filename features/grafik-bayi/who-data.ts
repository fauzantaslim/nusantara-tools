...
const boysHead: LMSPoint[] = [
  ...
  { month: 18, L: 1.0, M: 48.05, S: 0.0347 },
...
const girlsWeight: LMSPoint[] = [
  ...
  { month: 2, L: 0.2579, M: 5.1282, S: 0.13 },
...
const girlsHead: LMSPoint[] = [
  ...
  { month: 36, L: 1.0, M: 49.1, S: 0.03633 },
  { month: 48, L: 1.0, M: 50.05, S: 0.03689 },
  { month: 60, L: 1.0, M: 50.7, S: 0.03781 },
];
...
export const VALID_BOUNDS: Record<
  GrowthIndicator,
  { minCm: number; maxCm: number; unit: string }
> = {
