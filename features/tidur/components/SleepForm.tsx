...
export const SleepForm: React.FC<{ hook: SleepContextType }> = ({ hook }) => {
  ...
  return (
    <Card
      variant="default"
      className="lg:col-span-5 flex flex-col gap-8 p-6 sm:p-10 border border-[#EDE0D0] shadow-xl shadow-black/[0.03] rounded-[2.5rem] bg-white relative z-10 w-full h-full"
    >
