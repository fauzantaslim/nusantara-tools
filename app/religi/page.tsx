...
import { Activity, Moon, ChevronRight, Wallet, CheckCircle2, Calculator } from 'lucide-react';
...
export const metadata = {
  ...
  description: 'Koleksi lengkap penunjang ibadah harian: Jadwal Sholat, Arah Kiblat, Kalkulator Zakat, dan lainnya.',
};

const RELIGI_TOOLS = TOOLS.filter(t => t.category === 'Religi');

const OTHER_CATEGORIES = [
  { id: 'kesehatan', name: 'Kesehatan & Kebugaran', icon: Activity, color: 'text-[#4A7C59]', bg: 'bg-[#E8F5E9]', path: '/kesehatan', desc: 'Kalkulator BMI, Kalori, Masa Subur, dan pantauan kesehatan harian.', hoverBorder: 'hover:border-[#4A7C59]/40' },
    ...
    <div className="max-w-7xl mx-auto flex flex-col gap-12 w-full mt-4 pb-24 px-4">
      ...
      <div className="flex flex-col gap-6 pt-6 pb-4 border-b border-muted/50">
        ...
        <div>
          ...
          <h1 className="text-4xl sm:text-5xl font-black text-primary font-heading tracking-tight">Religi & Ibadah</h1>
          <p className="text-lg text-secondary font-body mt-3 max-w-2xl leading-relaxed">
            Kumpulan panduan dan utilitas cerdas untuk membantu Anda merencanakan dan menjalankan rutinitas ibadah dengan presisi dan keyakinan.
          </p>
        </div>
      </div>
