              ...
              <div
                className={cn(
                  ...
                  result.isWajib
                    ...
                    : "from-surface/5 via-transparent to-transparent",
                )}
              />
              <div
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full mt-auto">
                  <div className="bg-[#1A0E07]/60 rounded-2xl p-5 border border-white/10 flex flex-col gap-2">
                    ...
                    <span className="text-[10px] text-[#EDE0D0] opacity-50 font-body uppercase">
                      {mode === "monthly" ? "Per Bulan" : "Per Tahun"}
                    </span>
                  </div>
                  <div className="bg-[#1A0E07]/60 rounded-2xl p-5 border border-white/10 flex flex-col gap-2">
                    <span className="text-xs font-bold text-[#EDE0D0] opacity-60 uppercase tracking-widest flex items-center gap-1.5">
                    ...
                    <span className="text-[10px] text-[#EDE0D0] opacity-50 font-body uppercase">
                      {mode === "monthly" ? "Per Bulan" : "Per Tahun (2026)"}
                    </span>
                  </div>
                </div>
              ...
              <div className="relative z-10 flex flex-col items-center">
                <div className="relative w-32 h-32 flex items-center justify-center mb-6 mt-4">
                  ...
                  >
                    ...
                    <path
                      d="M50 80 Q200 10 350 80 V480 Q200 450 50 480 Z"
                      fill="#EDE0D0"
                      opacity="0.3"
                    />
                    ...
                    <g transform="translate(45, 100)">
                      <g transform="translate(0, 50)">
                        <path
                          d="M10 20 H70 A10 10 0 0 1 80 30 V70 A10 10 0 0 1 70 80 H10 A10 10 0 0 1 0 70 V30 A10 10 0 0 1 10 20 Z"
                          fill="#7A5C42"
                        />
                        <rect
                          x="15"
                        ...
                        <path
                          d="M75 25 Q80 15 85 25 Q80 35 75 25 Z"
                          fill="#4A7C59"
                      ...
                      <g transform="translate(230, 50)">
                        ...
                        <path
                          d="M30 30 A10 10 0 0 0 40 40 Q35 35 30 30 Z"
                          fill="#2C1A0E"
                          opacity="0.1"
                        />
                      </g>
                      ...
                      <g transform="translate(420, 50)">
                        <path
                          d="M0 30 V70 Q0 80 10 80 H60 Q70 80 70 70 V30 Z"
                          fill="#4A7C59"
                        />
                        <rect
                          x="15"
                        ...
                        <path
                          d="M10 40 Q15 35 20 40 T30 40 Q25 45 20 40 T10 40 Z"
                          fill="#EDE0D0"
                          opacity="0.3"
                        />
                      </g>
                    ...
                    />
                    <path
                      d="M200 450 L205 455 L200 460 Z"
                      fill="#9C4A2A"
                      opacity="0.5"
                    />
                  </svg>
                ...
                <p className="text-[#EDE0D0] font-body max-w-[280px] text-base leading-relaxed opacity-90">
                  Isi formulir nilai penghasilan di samping untuk mengetahui
                  besaran wajib zakat Anda sesuai BAZNAS.
                </p>
              </div>
            </Card>
          )}
          ...
          <div className="flex flex-col gap-16 relative z-10 w-full">
            ...
            <div className="flex flex-col gap-16 mx-auto w-full border-t border-[#7A5C42]/30 pt-16">
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="p-5 rounded-2xl bg-[#C17A3A]/10 border border-[#C17A3A]/30">
                      ...
                      <p className="text-[#EDE0D0] text-sm opacity-90 leading-relaxed">
                        ...
                        penuh. Tingkat standar wajib Zakat umumnya adalah
                        menggunakan rumus: <strong>Jumlah Zakat × 2.5%</strong>.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="p-6 sm:p-8 rounded-3xl bg-[#1A0E07]/40 border border-[#4A7C59]/30">
                    ...
                    <ul className="space-y-3 text-[#EDE0D0] font-body text-sm opacity-90">
                      ...
                      <li className="flex gap-3 items-start">
                        ...
                        Pendapatan sewa (setelah disisihkan biaya pengeluaran)
                      </li>
                      <li className="flex gap-3 items-start">
                        <span className="text-[#4A7C59] font-black mt-0.5">
                          •
                        </span>{" "}
                        Produksi pertanian dan ternak (berlaku tingkat ketentuan
                        khusus)
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="p-6 sm:p-8 rounded-3xl bg-[#1A0E07]/40 border border-white/20 relative">
                    ...
                    <ul className="space-y-3 text-[#EDE0D0] font-body text-sm opacity-90">
                      ...
                      <li className="flex gap-3 items-start">
                        ...
                        Aset atau barang simpanan yang total nilainya di bawah
                        ambang nisab
                      </li>
                    </ul>
                  </div>
              ...
              <section className="space-y-8">
                ...
                <div className="bg-white/5 border border-white/10 rounded-3xl p-6 sm:p-8 text-[#EDE0D0]">
                  <p className="mb-6 text-sm sm:text-base leading-relaxed opacity-90">
                    Berdasarkan ketetapan Q.S. At-Taubah (ayat 60), Zakat
                    didistribusikan kepada delapan kategori pihak yang berhak
                    menerima (Asnaf):
                  </p>
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    {[
                      "Orang miskin (Al-Fuqara)",
                      "Orang membutuhkan (Al-Masakin)",
                      "Pengelola Zakat (Amil)",
                      "Hatinya didamaikan (Muallaf)",
                      "Terikat budak tawanan (Riqab)",
                      "Yang terlilit utang (Gharimin)",
                      "Di jalan Allah (Fisabilillah)",
                      "Musafir terdampar (Ibnu Sabil)",
                    ].map((col, idx) => (
                      <div
                        key={idx}
                        className="bg-white/5 rounded-xl px-4 py-3 text-sm font-bold font-heading border border-white/5"
                      >
                        {idx + 1}. {col}
                      </div>
                    ))}
              ...
              <section className="space-y-8">
                <div className="flex items-center gap-4 border-b border-[#7A5C42]/30 pb-4">
                  ...
                  <h3 className="text-2xl font-bold font-heading text-white">
                    Pertanyaan Umum (FAQ) & Manfaat Kalkulator
                  </h3>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-6">
                    <div className="p-6 rounded-2xl bg-[#C17A3A]/10 border border-[#C17A3A]/20">
                      <h4 className="font-heading font-bold text-white mb-2 text-lg">
                        Bagaimana Cara Kerja Kalkulator
                      </h4>
                      <ul className="space-y-3 text-[#EDE0D0] font-body text-sm opacity-90 mt-4">
                        <li className="flex gap-3">
                          <CheckCircle2 className="w-5 h-5 text-[#C17A3A] shrink-0" />{" "}
                          <div>
                            <strong>Input Disesuaikan:</strong> Memasukkan nilai
                            aset dan otomatis menghilangkan kebutuhan komputasi
                            manual.
                          </div>
                        </li>
                        <li className="flex gap-3">
                          <CheckCircle2 className="w-5 h-5 text-[#C17A3A] shrink-0" />{" "}
                          <div>
                            <strong>Pemotongan Dinamis:</strong> Hasil akurat
                            menggunakan tarif standar 2,5% dan disajikan melalui
                            wawasan visual yang nyaman dibaca.
                          </div>
                        </li>
                      </ul>
                    </div>
                    <div className="p-6 rounded-2xl bg-[#4A7C59]/10 border border-[#4A7C59]/20">
                      ...
                      <ul className="space-y-3 text-[#EDE0D0] font-body text-sm opacity-90 mt-4">
                        <li className="flex gap-2">
                          <span>1.</span> <strong>Pemurnian Spiritual:</strong>{" "}
                          Membersihkan kekayaan dan memurnikan hati dari sifat
                          keserakahan.
                        </li>
                        <li className="flex gap-2">
                          <span>2.</span> <strong>Kesejahteraan Sosial:</strong>{" "}
                          Mendukung kelompok tak beruntung dan mengurangi
                          ketidaksetaraan ekonomi.
                        </li>
                        <li className="flex gap-2">
                          <span>3.</span>{" "}
                          <strong>Pertumbuhan Komunitas:</strong> Merajut ikatan
                          bermasyarakat yang lebih kuat dan ikhlas berbagi.
                        </li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col gap-4">
                    <div className="bg-white/5 border border-white/10 p-5 rounded-2xl hover:bg-white/10 transition-colors">
                      <h4 className="font-bold text-white mb-1">
                        Kapan Saya Harus Membayar Zakat?
                      </h4>
                      <p className="text-sm text-[#EDE0D0] opacity-80 leading-relaxed">
                        Zakat jatuh tempo setiap tahun dan harus dibayar
                        seketika setelah kekayaan Anda melebihi ambang batas
                        Nisab dan mutlak dimiliki selama satu tahun lunar penuh.
                      </p>
                    </div>
                    <div className="bg-white/5 border border-white/10 p-5 rounded-2xl hover:bg-white/10 transition-colors">
                      <h4 className="font-bold text-white mb-1">
                        Apa Saja Pengurangan yang Valid?
                      </h4>
                      <p className="text-sm text-[#EDE0D0] opacity-80 leading-relaxed">
                        Kewajiban seperti utang darurat dan pengeluaran primer
                        wajib yang sangat diperlukan dapat dikonversikan sebagai
                        faktor pengurang sebelum menghitung target Zakat.
                      </p>
                    </div>
                    <div className="bg-white/5 border border-white/10 p-5 rounded-2xl hover:bg-white/10 transition-colors">
                      <h4 className="font-bold text-white mb-1">
                        Apa yang Terjadi Jika Di Bawah Nisab?
                      </h4>
                      <p className="text-sm text-[#EDE0D0] opacity-80 leading-relaxed">
                        Jika total kekayaan Anda ternyata berada secara mutlak
                        di bawah Nisab, Anda tidak diwajibkan syariah untuk
                        mengeluarkan Zakat pendapatan tersebut.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-[#1A0E07]/60 p-6 sm:p-8 rounded-[2rem] border border-[#9C4A2A]/40 text-center max-w-3xl mx-auto shadow-inner relative overflow-hidden mt-4">
              ...
              <h4 className="font-heading font-extrabold text-[#FFF0EB] text-lg mb-3">
                Disclaimer & Keterbatasan Kalkulasi
              </h4>
              <p className="text-[#EDE0D0] font-body text-sm leading-relaxed">
                NusantaraTools Kalkulator Zakat memfasilitasi rumus simulasi
                perhitungan murni sesuai angka keputusan BAZNAS dan tidak
                melayani transaksi resmi (bukan amil). Nilai rupiah nisab ini
                dapat berubah/dievaluasi oleh institusi berwenang pada kalender
                Hijriyah tahun berikutnya. Kami merekomendasikan Anda
                membayarkannya kepada lembaga amil zakat seperti LAZ/BAZNAS.
              </p>
            </div>
          </div>
        </div>
