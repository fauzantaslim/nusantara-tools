          ...
          return (
            ...
            >
              ...
              <div className="flex items-center justify-between pt-4 border-t border-muted/50 mt-auto relative z-10">
                ...
                <div className="w-8 h-8 rounded-full bg-surface flex flex-col items-center justify-center transition-colors group-hover:bg-[#7A5C42]">
