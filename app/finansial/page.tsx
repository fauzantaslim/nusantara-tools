...
export default function FinansialIndex() {
  return (
    <div className="max-w-7xl mx-auto flex flex-col gap-12 w-full mt-4 pb-24 px-4">
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center justify-between pt-4 border-t border-muted/50 mt-auto relative z-10">
                ...
                <div className="w-8 h-8 rounded-full bg-surface flex flex-col items-center justify-center transition-colors group-hover:bg-[#9C4A2A]">
      ...
      <CategoryRelated
        currentCategoryId="finansial"
        description="Jelajahi portofolio kalkulator kami untuk kebutuhan kesehatan hingga produktivitas."
      />
    </div>
  );
}
