  ...
  const handleCalculate = (e: React.FormEvent) => {
    ...
    try {
      const input: PregnancyInput = {
        ...
        ultrasoundWeeks:
          method === "ULTRASOUND" ? parseInt(ultrasoundWeeks, 10) : undefined,
        ultrasoundDays:
          method === "ULTRASOUND" ? parseInt(ultrasoundDays, 10) : undefined,
      };
          ...
          {result ? (
            ...
            >
              ...
              <p className="text-[#EDE0D0] font-body max-w-sm text-lg leading-relaxed relative z-10 opacity-90">
                Lengkapi tanggal pada formulir untuk memperkirakan hari
                kelahiran dan melihat tonggak penting kehamilan Anda.
              </p>
            </Card>
          )}
        </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="bg-[#1A0E07]/40 p-6 rounded-2xl border border-[#7A5C42]/20 shadow-inner">
                      <h4 className="font-bold text-[#4A7C59] mb-2 font-heading text-lg">
                        Sejauh mana presisi output hari kelahiran?
                      </h4>
                      <p className="text-[#EDE0D0] font-body text-sm leading-relaxed">
                        Secara klinis output ini adalah proyeksi. Periode
                        standar berpusar pada angka 40 minggu, namun
                        kelahirannya fluktuatif maju mundur dari hari
                        terprediksi secara biologis alami.
                      </p>
                    </div>
                    <div className="bg-[#1A0E07]/40 p-6 rounded-2xl border border-[#7A5C42]/20 shadow-inner">
                      <h4 className="font-bold text-[#4A7C59] mb-2 font-heading text-lg">
                        Apakah reliabel jika saya adalah partisipan fertilisasi
                        in vitro (IVF)?
                      </h4>
                      <p className="text-[#EDE0D0] font-body text-sm leading-relaxed">
                        Tentu saja. Tersedia variabel opsi "Transfer IVF" khusus
                        untuk mengamankan data proyeksi via parameter masa hidup
                        pascatransfer awal.
                      </p>
                    </div>
                    <div className="bg-[#1A0E07]/40 p-6 rounded-2xl border border-[#7A5C42]/20 shadow-inner">
                      <h4 className="font-bold text-[#4A7C59] mb-2 font-heading text-lg">
                        Bagaimana solusinya apabila siklus HPHT kelupaan?
                      </h4>
                      <p className="text-[#EDE0D0] font-body text-sm leading-relaxed">
                        Sistem dilengkapi cadangan alternatif melalui pendekatan
                        "Tanggal USG" maupun "Tanggal Konsepsi" dimana sistem
                        re-kalkulasi akan berjalan merefleksikan tanggal
                        alternatif tsb.
                      </p>
                    </div>
                    <div className="bg-[#1A0E07]/40 p-6 rounded-2xl border border-[#7A5C42]/20 shadow-inner">
                      <h4 className="font-bold text-[#4A7C59] mb-2 font-heading text-lg">
                        Rekomendasi repetisi kalkulasi ini?
                      </h4>
                      <p className="text-[#EDE0D0] font-body text-sm leading-relaxed">
                        Bisa digunakan seperlunya misal ketika jadwal periksa
                        rutin, guna mencocokkan sinkronisasi usia gestasi di
                        hasil kalkulator dengan status aktual dari rekam medis
                        dokter.
                      </p>
                    </div>
                  </div>
