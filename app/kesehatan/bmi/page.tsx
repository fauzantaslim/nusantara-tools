      ...
      <div className="w-full mt-4 mb-4 bg-[#1A0E07]/60 p-5 rounded-[2rem] border border-white/5 shadow-inner backdrop-blur-md  ">
        ...
        <div className="relative w-full pt-4 pb-2 ">
          ...
          <div className="h-10 rounded-xl flex overflow-hidden w-full relative z-10 shadow-inner opacity-90 ring-1 ring-inset ring-white/10">
            ...
            <div
              className="h-full bg-[#4A7C59] flex items-center justify-center border-r border-[#2C1A0E]/40 transition-all"
              style={{ width: "27.1%" }}
            >
            ...
            <div
              className="h-full bg-[#C17A3A] flex items-center justify-center border-r border-[#2C1A0E]/40 transition-all"
              style={{ width: "20.8%" }}
            >
            ...
            <div
              className="h-full bg-[#9C4A2A] flex items-center justify-center transition-all"
              style={{ width: "41.7%" }}
            >
              <span className="text-[10px] sm:text-xs font-bold text-white px-1">
                Obesitas
          ...
          {result && theme ? (
            ...
            >
              ...
              <p className="text-[#EDE0D0] font-body max-w-sm text-base sm:text-lg leading-relaxed relative z-10 opacity-90 px-4">
                Lengkapi data diri Anda pada formulir untuk memperoleh analisis
                medis standar akurat.
              </p>
            </Card>
          )}
        </div>
