...
import { Activity, Moon, ChevronRight, CalendarHeart } from "lucide-react";

const RELATED_TOOLS = [
  {
    id: "bmi",
    name: "Kalkulator BMI Ideal",
    icon: Activity,
    path: "/kesehatan/bmi",
    desc: "Hitung tingkat ideal massa tubuh secara akurat berdasarkan standar metrik dan imperial.",
  },
  {
    id: "hpl",
    ...
    desc: "Prediksi Hari Perkiraan Lahir dan pantau tonggak penting perjalanan kehamilan Anda.",
  },
  {
    id: "masa-subur",
    ...
    desc: "Kalkulasi siklus menstruasi otomatis dan ketahui secara akurat jendela masa subur Anda.",
  },
];
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8 gap-4">
        <div>
          <h2 className="text-2xl font-bold font-heading text-primary">
            Kalkulator Kesehatan Lainnya
          </h2>
          <p className="text-secondary font-body mt-1 text-sm sm:text-base">
            Eksplorasi utilitas dan asesmen kebugaran kami yang lain
          </p>
        </div>
        <Link
          href="/kesehatan"
          className="text-sm font-bold text-[#4A7C59] hover:text-[#2C1A0E] flex items-center transition-colors px-4 py-2 rounded-xl bg-[#4A7C59]/10"
        >
