...
export const TOOLS = [
  ...
  { id: 'masa-subur', name: 'Kalkulator Masa Subur', category: 'Kesehatan', categoryId: 'kesehatan', icon: Activity, color: 'text-[#4A7C59]', bg: 'bg-[#E8F5E9]', path: '#', desc: 'Kalkulasi siklus menstruasi dan prediksi jendela masa subur wanita.', hot: true },
  { id: 'kalori', name: 'Kalkulator Kalori Harian', category: 'Kesehatan', categoryId: 'kesehatan', icon: Activity, color: 'text-[#4A7C59]', bg: 'bg-[#E8F5E9]', path: '#', desc: 'Hitung kebutuhan kalori harian (TDEE) untuk mencapai target berat badan.', hot: false },
  { id: 'air', name: 'Kalkulator Kebutuhan Air', category: 'Kesehatan', categoryId: 'kesehatan', icon: Activity, color: 'text-[#4A7C59]', bg: 'bg-[#E8F5E9]', path: '#', desc: 'Estimasi asupan cairan yang wajib dipenuhi per hari berdasarkan level rutinitas.', hot: false },
  { id: 'sleep', name: 'Sleep Cycle Calculator', category: 'Kesehatan', categoryId: 'kesehatan', icon: Moon, color: 'text-[#4A7C59]', bg: 'bg-[#E8F5E9]', path: '#', desc: 'Temukan jam tidur dan bangun ideal untuk menghindari rasa lelah.', hot: true },
  { id: 'ideal-weight', name: 'Cek Berat Badan Ideal', category: 'Kesehatan', categoryId: 'kesehatan', icon: Activity, color: 'text-[#4A7C59]', bg: 'bg-[#E8F5E9]', path: '#', desc: 'Ketahui rentang berat badan ideal berdasarkan tinggi tubuh dan usia.', hot: false },
  { id: '1rm', name: 'Kalkulator 1RM', category: 'Kesehatan', categoryId: 'kesehatan', icon: Activity, color: 'text-[#4A7C59]', bg: 'bg-[#E8F5E9]', path: '#', desc: 'Hitung porsi beban maksimum untuk satu repetisi latihan angkat beban.', hot: false },
  { id: 'kafein', name: 'Kalkulator Kafein Aman', category: 'Kesehatan', categoryId: 'kesehatan', icon: Activity, color: 'text-[#4A7C59]', bg: 'bg-[#E8F5E9]', path: '#', desc: 'Batas asupan kopi dan minuman berkafein harian sesuai kondisi tubuh.', hot: false },
  ...
  { id: 'grafik-bayi', name: 'Grafik Pertumbuhan Bayi', category: 'Kesehatan', categoryId: 'kesehatan', icon: Activity, color: 'text-[#4A7C59]', bg: 'bg-[#E8F5E9]', path: '#', desc: 'Pantau kurva pertumbuhan tinggi dan berat badan anak sesuai standar WHO.', hot: false },
  { id: 'tekanan-darah', name: 'Kalkulator Tekanan Darah', category: 'Kesehatan', categoryId: 'kesehatan', icon: Activity, color: 'text-[#4A7C59]', bg: 'bg-[#E8F5E9]', path: '#', desc: 'Evaluasi hasil tensi darah dan pahami kategori kesehatannya.', hot: false },
  { id: 'diabetes', name: 'Risiko Diabetes', category: 'Kesehatan', categoryId: 'kesehatan', icon: Activity, color: 'text-[#4A7C59]', bg: 'bg-[#E8F5E9]', path: '#', desc: 'Skrining awal tingkat risiko diabetes berdasarkan gaya hidup dan keturunan.', hot: false },
  ...
  { id: 'uang-habis', name: 'Berapa Lama Uang Habis?', category: 'Finansial', categoryId: 'finansial', icon: Wallet, color: 'text-[#9C4A2A]', bg: 'bg-[#FFF0EB]', path: '#', desc: 'Kalkulasi burn-rate tabungan berdasarkan pengeluaran bulanan.', hot: true },
