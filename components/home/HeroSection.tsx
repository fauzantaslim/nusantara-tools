...
import { ArrowRight, CheckCircle2, Wallet, Moon, Timer } from "lucide-react";
      ...
      <div className="relative z-10 flex flex-col gap-6 lg:gap-8 lg:pr-8 w-full lg:w-1/2">
        <div>
          <h1 className="text-5xl sm:text-6xl md:text-7xl font-heading font-extrabold text-primary leading-[1.05] tracking-tight w-full">
            Tools gratis untuk <span className="text-accent-1">semua</span>{" "}
        ...
        <p className="font-body text-lg sm:text-xl text-secondary w-full max-w-[500px] leading-relaxed">
          Platform esensial berisi kumpulan alat bantu harian gratis untuk
          pelajar, pekerja, hingga urusan islami dan finansial. Semuanya cepat,
          sederhana, dan dirancang khusus dengan metrik Indonesia.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 pt-2 w-full sm:w-auto">
          <Link href="#kategori" className="w-full sm:w-auto">
            <Button
              variant="primary"
              className="group flex items-center justify-center gap-2 w-full sm:w-auto px-8 py-4 sm:py-5 text-lg shadow-md hover:shadow-lg"
            >
              Mulai Eksplorasi
          ...
          <Link href="#kategori" className="w-full sm:w-auto">
            <Button
              variant="secondary"
              className="w-full sm:w-auto px-8 py-4 sm:py-5 text-lg bg-surface/50 backdrop-blur-sm"
            >
              Lihat Katalog Tools
            </Button>
          </Link>
          ...
          <div className="absolute inset-0 transition-transform duration-500 hover:scale-[1.02]">
            ...
            <div className="absolute top-4 sm:top-8 left-0 sm:left-4 bg-white p-4 sm:p-5 rounded-2xl shadow-lg border border-muted w-44 sm:w-52 hover:-translate-y-2 transition-transform duration-500 z-20">
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-[10px] font-bold px-2 py-1 bg-surface text-secondary rounded-full uppercase">
                  Finansial
                </span>
              </div>
            ...
            <div className="absolute top-1/2 right-0 sm:-right-4 -translate-y-1/2 bg-white p-5 rounded-3xl shadow-2xl border border-muted w-52 sm:w-60 hover:-translate-y-2 transition-transform duration-500 z-40">
              <div className="flex items-center gap-3 mb-5">
                ...
                <div>
                  <div className="font-bold text-primary font-heading leading-tight">
                    Sesi Pomodoro
                  </div>
                  <div className="text-[10px] font-bold text-accent-1 uppercase opacity-80 mt-0.5 tracking-wider">
                    Fokus Kerja
                  </div>
                </div>
              </div>
